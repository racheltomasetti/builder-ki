  ...
  const extractExifData = async (
    ...
    try {
      ...
      if (exifData) {
        ...
        console.log("DateTimeOriginal value:", exifData.DateTimeOriginal);
        console.log("DateTimeOriginal type:", typeof exifData.DateTimeOriginal);
        console.log("DateTimeOriginal is Date?:", exifData.DateTimeOriginal instanceof Date);
        ...
        console.log("Selected dateString type:", typeof dateString);
        console.log("Selected dateString is Date?:", dateString instanceof Date);
        ...
        if (dateString) {
          try {
            ...
            console.log("DEBUG - Date part extracted:", datePart);
            console.log("DEBUG - Final parsed date:", originalDate);
          } catch (parseErr) {
